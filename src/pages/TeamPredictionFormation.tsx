...
const TeamPredictionFormation = () => {
  ...
  const initializeFormation = (formation: FormationConfig, allPlayers: LineupPlayer[]) => {
    ...
    // Tutti i giocatori vanno in panchina inizialmente, ordinati per ruolo
...
export default TeamPredictionFormation;